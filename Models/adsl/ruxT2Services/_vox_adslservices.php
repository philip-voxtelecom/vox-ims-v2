...
class VoxADSL {
    ...
    function loadMethod($service, $methodName) {
         ...
         * Quota services
         */
        $methodList['quota']['URL'] = $URL_ADSL_SERVICES;
        $methodList['quota']['exchange'] = $URL_ADSL_SERVICES_EXCHANGE;
        $methodList['quota']['username'] = $URL_ADSL_SERVICES_USER;
        $methodList['quota']['password'] = $URL_ADSL_SERVICES_PASS;
        $methodList['quota']['method']['deletequotawheelsbyaccount'] = '/V2/ADSL/QUOTA/DELETEQUOTAWHEELSBYACCOUNT';
        $methodList['quota']['method']['addquotawheeltoaccount'] = '/V2/ADSL/QUOTA/ADDQUOTAWHEELTOACCOUNT';
