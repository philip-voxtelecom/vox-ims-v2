...
<table id="list_tbl" class="">
    ...
    <tr class="empty">
        ...
        {if $offset == 0 and $count > $rowlimit}     
                <a href="#" onclick="
                    viewarray={ldelim}search:'{$search}',offset:{$offset+$rowlimit},something:null,cancelled: xajax.$('showcancelled').checked{rdelim};
                    xajax_displayAccountList(viewarray);"
